...
2. Download the database *gender_db.duckdb* into the project directory from our google drive directly (~ 16GB) from the folder *duckdb_database* and skip database creation cells in the notebook
